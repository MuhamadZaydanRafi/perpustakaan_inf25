                    ...
                    <div class="card-header" id="heading-<?= $idAccordion ?>">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left" type="button" data-toggle="collapse" data-target="#<?= $idAccordion ?>" aria-expanded="false" aria-controls="<?= $idAccordion ?>">
                                ...
                                <span class="badge badge-success"><?= $totalPeminjaman ?> Diterima</span>
                            </button>
                        </h2>
                    </div>

                    <div id="<?= $idAccordion ?>" class="collapse" aria-labelledby="heading-<?= $idAccordion ?>" data-parent="#peminjamanDiterimaAccordion">
