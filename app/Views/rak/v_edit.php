<div class="col-md-12">
            <div class="card card-outline card-primary">
              ...
              ?>
              <?php echo form_open('admin/rak/updatedata/'. $rak['id_rak']) ?>

                <div class="row">
                    <div class="col-sm-6">
                    <div class="form-group">
                        <label>Nama Rak</label>
                        <input name="nama_rak" value="<?= $rak['nama_rak'] ?>" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="lantai_rak" value="<?= $rak['lantai_rak'] ?>" class="form-control">
