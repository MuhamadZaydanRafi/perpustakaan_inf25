            ...
            <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a href="<?= base_url('detailebook/'. $value['id_ebook']) ?>" class="btn btn-sm btn-primary">
                            <i class="fas fa-eye"></i> Lihat Detail
                        </a>
                        <?php if($value['file_ebook']): ?>
                            <a href="<?= base_url('admin/ebook/download/'. $value['id_ebook']) ?>" class="btn btn-sm btn-info">
