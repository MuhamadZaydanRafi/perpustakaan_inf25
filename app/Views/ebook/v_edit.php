<div class="col-md-12">
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      ?>
      <?php echo form_open_multipart('admin/ebook/updatedata/'. $ebook['id_ebook']) ?>

      <div class="row">
        <div class="col-sm-12">
          <div class="form-group">
            <label>Judul E-Book</label>
            <input name="judul_ebook" value="<?= $ebook['judul_ebook'] ?>" class="form-control">
          ...
          <div class="form-group">
            ...
            <select name="id_kategori" class="form-control">
              ...
              <?php foreach($kategori as $kat): ?>
                <option value="<?= $kat['id_kategori'] ?>" <?= $ebook['id_kategori'] == $kat['id_kategori'] ? 'selected' : '' ?>>
                  <?= $kat['nama_kategori'] ?>
                </option>
              <?php endforeach; ?>
            </select>
          ...
          <div class="form-group">
            ...
            <select name="id_penerbit" class="form-control">
              ...
              <?php foreach($penerbit as $p): ?>
                <option value="<?= $p['id_penerbit'] ?>" <?= $ebook['id_penerbit'] == $p['id_penerbit'] ? 'selected' : '' ?>>
                  <?= $p['nama_penerbit'] ?>
                </option>
              <?php endforeach; ?>
            </select>
      ...
      <div class="row">
          ...
          <div class="form-group">
            ...
            <select name="id_penulis" class="form-control">
              ...
              <?php foreach($penulis as $pen): ?>
                <option value="<?= $pen['id_penulis'] ?>" <?= $ebook['id_penulis'] == $pen['id_penulis'] ? 'selected' : '' ?>>
                  <?= $pen['nama_penulis'] ?>
                </option>
              <?php endforeach; ?>
            </select>
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <label>Tahun</label>
            <input name="tahun" type="number" value="<?= $ebook['tahun'] ?>" class="form-control">
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            <label>ISBN</label>
            <input name="isbn" value="<?= $ebook['isbn'] ?>" class="form-control">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <label>Bahasa</label>
            <input name="bahasa" value="<?= $ebook['bahasa'] ?>" class="form-control">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <textarea name="sinopsis" rows="4" class="form-control"><?= $ebook['sinopsis'] ?></textarea>
          ...
          <div class="form-group">
            ...
            <?php if($ebook['cover']): ?>
              <div class="mt-2">
                ...
                <img src="<?= base_url('uploads/cover/'. $ebook['cover']) ?>" alt="cover" style="max-width: 150px; height: auto;">
              </div>
            <?php endif; ?>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <?php if($ebook['file_ebook']): ?>
              <div class="mt-2">
                <p class="text-muted">File saat ini:</p>
                <a href="<?= base_url('admin/ebook/download/'. $ebook['id_ebook']) ?>" class="btn btn-sm btn-info">
